...
class Beetle extends THREE.Object3D {
    ...
    build() {
        ...
        const luggage = new THREE.Mesh(luggage_geometry, this.sofaMaterial);
        ...
        const windshield = new THREE.Mesh(windshield_geometry, this.sofaMaterial);
        ...
        const hood = new THREE.Mesh(hood_geometry, this.sofaMaterial);
        ...
        const back_wheel = new THREE.Mesh(back_wheel_geometry, this.sofaMaterial);
        ...
        const front_wheel = new THREE.Mesh(front_wheel_geometry, this.sofaMaterial);
